...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_every', action='store', type=int, default=5000, help='eval_every', required=False)
    parser.add_argument('--validate_every', action='store', type=int, default=5000, help='validate_every', required=False)
